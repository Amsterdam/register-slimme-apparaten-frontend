    ...
    <Fragment>
      ...
      <div className="modal-body">
        ...
        <section>
          ...
          <ul>
            <li><a href="#wat is het">Wat het &#39;Register slimme apparaten&#39; is</a></li>
            <li><a href="#beta status">Beta status register</a></li>
            <li><a href="#beschikbaarheid">Beschikbaarheid data in het register</a></li>
            <li><a href="#klopt niet of mist">Als er data niet klopt of mist naar uw mening</a></li>
            <li><a href="#hergebruik data">Hergebruik data</a></li>
            <li><a href="#verantwoordelijkheid">Verantwoordelijkheid gemeente Amsterdam en eigenaren van de data in het register slimme apparaten</a></li>
            <li><a href="#aansprakelijkheid">Aansprakelijkheid gemeente Amsterdam</a></li>
          </ul>
        </section>

        <section>
          <h4 id="wat is het">Wat het &#39;Register slimme apparaten&#39; is</h4>
        ...
        <section>
          <h4 id="beta status">Beta status register</h4>
        ...
        <section>
          <h4 id="beschikbaarheid">Beschikbaarheid data in het register</h4>
        ...
        <section>
          <h4 id="klopt niet of mist">Als er iets niet klopt of mist naar uw mening</h4>
        ...
        <section>
          <h4 id="hergebruik data">Hergebruik data register</h4>
        ...
        <section>
          <h4 id="verantwoordelijkheid">Verantwoordelijkheid gemeente Amsterdam en eigenaren van de data voor data in het register slimme apparaten</h4>
        ...
        <section>
          <h4 id="aansprakelijkheid">Aansprakelijkheid gemeente Amsterdam</h4>
